    ...
    <header className="hidden md:flex items-center gap-4 px-6 h-[57px] bg-[var(--bg-sidebar)] border-b border-[var(--border)] flex-shrink-0">
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        {action && (
          <Link
            href={action.href}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-xs font-medium transition-colors shadow-sm shadow-blue-600/20"
          >

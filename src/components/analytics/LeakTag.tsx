...
const MAP: Record<LeakStage, { label: string; cls: string; hint: string }> = {
  never_dialed: { label: "Never-dialed", cls: "bg-amber-500/12 text-amber-400 border-amber-500/30", hint: "Capacity/throughput — resume/extend/add workers" },
  ...
  conversion: { label: "Conversion", cls: "bg-blue-500/12 text-blue-400 border-blue-500/30", hint: "Script / offer / assistant review" },

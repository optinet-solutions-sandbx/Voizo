...
// Renamed from default export `NewCampaignV2Page` during the wizard port
// (slice 0). Kept as a named React component so the new route shell at
// `./page.tsx` can render it as the classic fallback while the wizard is
// gated behind `?wizard=1`. Do not import this directly from outside
// `./page.tsx`; the route is the only consumer.
export function ClassicNewCampaignPage() {
